...
│       new SwooleSocketTransport('/var/run/stream.sock'),                       │
│       'stream> '                                                             │
│   );                                                                         │
│   $streamingShell->run();                                                    │
│                                                                               │
...
$transport = new SwooleSocketTransport('/var/run/my-shell.sock');
$shell = new Shell($transport, 'myapp> ');
$shell->run();
```
...
│             Check transport supports streaming (SwooleSocketTransport)         │
